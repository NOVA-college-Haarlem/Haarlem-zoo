        ...
        <div class="container">
            <div class="row g-5 d-flex justify-content-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p><span class="text-primary me-2">#</span>Please register!</p>
                    <h4 class="display-3 mb-4">Want to visit us? Please register</h4>
                    <p class="mb-4">Fill in your data and wait for the mail and presto!</p>
                    <form method="post" action="register/register_process.php">
                        <div class="row g-3">

                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control bg-light border-0" id="firstname" placeholder="Your firstname">
                                    <label for="firstname">Your Firstname</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control bg-light border-0" id="email" name="lastname" placeholder="Your lastname">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="password" class="form-control bg-light border-0" id="password" name="password" placeholder="Subject">
